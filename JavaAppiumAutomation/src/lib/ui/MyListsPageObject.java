...
public class MyListsPageObject extends MainPageObject{
    ...
    public void waitForArticleToApearByTtile(String article_title){
    ...
    public void swipeArticleToDelete (String article_title){
        this.waitForArticleToApearByTtile(article_title);
        String article_xpath = getSavedArticleXpathByTitile(article_title);
        this.swipeElementToLeft(
                By.xpath(article_xpath),
                "Cannot find saved article"
        );
        this.waitForArticleToDisapearByTtile(article_title);
    }

    public void waitForArticleToDisapearByTtile(String article_title){
        String article_xpath = getSavedArticleXpathByTitile(article_title);
